/*
 ...
 Source Schema         : pg_database_sit

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 13/07/2020 17:29:55
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 222 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 357 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
-- ----------------------------
-- Table structure for tb_address_admin
-- ----------------------------
DROP TABLE IF EXISTS `tb_address_admin`;
CREATE TABLE `tb_address_admin`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `address_nums` int(11) NOT NULL,
  `uncharged_address_nums` int(11) NOT NULL,
  `update_time` datetime(6) NOT NULL ON UPDATE CURRENT_TIMESTAMP(6),
  `pro_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `tb_address_admin_token_name_pro_id_bbef8cd9_uniq`(`token_name`, `pro_id`) USING BTREE,
  INDEX `tb_address_admin_pro_id_7a4818d3_fk_tb_project_pro_id`(`pro_id`) USING BTREE,
  CONSTRAINT `tb_address_admin_pro_id_7a4818d3_fk_tb_project_pro_id` FOREIGN KEY (`pro_id`) REFERENCES `tb_project` (`pro_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 24980 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for tb_asset_daily_report
-- ----------------------------
DROP TABLE IF EXISTS `tb_asset_daily_report`;
CREATE TABLE `tb_asset_daily_report`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `deposit_amount` decimal(28, 8) NOT NULL,
  `withdraw_amount` decimal(28, 8) NOT NULL,
  `collectionRecords_amount` decimal(28, 8) NOT NULL,
  `all_balance` decimal(28, 8) NOT NULL,
  `update_time` datetime(6) NOT NULL,
  `pro_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `tb_asset_daily_report_pro_id_96cdfb1b_fk_tb_project_pro_id`(`pro_id`) USING BTREE,
  CONSTRAINT `tb_asset_daily_report_pro_id_96cdfb1b_fk_tb_project_pro_id` FOREIGN KEY (`pro_id`) REFERENCES `tb_project` (`pro_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1855 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 6062 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_deposit`  (
  ...
  `tx_confirmations` int(11) NOT NULL COMMENT '交易的区块确认数',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uidx_pro_id_token_name_tx_hash_to_addr`(`pro_id`, `token_name`, `tx_hash`, `to_addr`) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 13171 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_project`  (
  ...
  `last_login` datetime(6) NULL DEFAULT NULL COMMENT '上次登录',
  `password` varchar(80) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL COMMENT '密码',
...
-- ----------------------------
-- Table structure for tb_user_operation_log
-- ----------------------------
DROP TABLE IF EXISTS `tb_user_operation_log`;
CREATE TABLE `tb_user_operation_log`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `operation_time` datetime(6) NOT NULL,
  `function_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `operation_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `update_before_value` varchar(800) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `last_after_value` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `operation_status` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `pro_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `tb_user_operation_log_pro_id_dd80f1b1_fk_tb_project_pro_id`(`pro_id`) USING BTREE,
  CONSTRAINT `tb_user_operation_log_pro_id_dd80f1b1_fk_tb_project_pro_id` FOREIGN KEY (`pro_id`) REFERENCES `tb_project` (`pro_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 137 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for tb_user_token_balances
-- ----------------------------
DROP TABLE IF EXISTS `tb_user_token_balances`;
CREATE TABLE `tb_user_token_balances`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `token_name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `all_balance` decimal(28, 8) NOT NULL,
  `withdraw_address` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `withdraw_balance` decimal(28, 8) NOT NULL,
  `update_time` datetime(6) NOT NULL,
  `pro_id` int(11) NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `tb_user_token_balances_pro_id_token_name_98b34354_uniq`(`pro_id`, `token_name`) USING BTREE,
  CONSTRAINT `tb_user_token_balances_pro_id_13594074_fk_tb_project_pro_id` FOREIGN KEY (`pro_id`) REFERENCES `tb_project` (`pro_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
