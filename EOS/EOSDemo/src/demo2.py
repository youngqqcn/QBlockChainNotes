...
trx['expiration'] = str((dt.datetime.utcnow() + dt.timedelta(seconds=60*10)).replace(tzinfo=pytz.UTC))
...
brsp = ce.post('chain.push_transaction', params=None, data=resp, timeout=30)
