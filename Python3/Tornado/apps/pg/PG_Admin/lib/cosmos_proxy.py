...
from lib.my_bech32 import Bech32AddrToHex
...
class CosmosProxy(object):
    ...
    def  getHRC20TokenBalance(self, contract_addr : str, address : str) -> str:
        ...
        balance =   int(data, 16) * 1.0 / 10**(ndecimals)
        if balance < 0.00000001: return  '0.00000000'
        # balance.quantize(Decimal("0.00000000"), getattr(decimal, 'ROUND_DOWN'))
        # strfmt_balance = RoundDown(Decimal( balance ))
