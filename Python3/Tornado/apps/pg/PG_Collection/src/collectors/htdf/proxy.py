...
from src.collectors.htdf.my_bech32 import Bech32AddrToHex
...
class HTDFProxy(object):
    ...
    def _post_json_call(self,  subPath , params):
        ...
        try:
            ...
            raise BadJsonError("error: {},{}".format( e , str(r.text)) )
    ...
    def _get_url_call(self, strUrl):
        ...
        try:
            ...
            raise BadStatusCodeError("HTTP,{}:{}, {}".format (r.status_code, r.text, e))
        pass
