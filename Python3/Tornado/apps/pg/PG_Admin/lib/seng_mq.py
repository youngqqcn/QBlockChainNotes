...
from PG_Admin.settings import RABBIT_MQ_IP,RABBIT_MQ_PORT,RABIIT_MQ_USER_NAME,RABIIT_MQ_PASSWORD,RABBIT_MQ_VRIATUAL_HOST,\
...
def send_order_id_to_msq(tx_hash_json : dict) -> None:
    ...
    :return:
    '''
    logger.info(f'send_order_msq : start')
    ...
    logger.info(f'send_order_msq : end')
