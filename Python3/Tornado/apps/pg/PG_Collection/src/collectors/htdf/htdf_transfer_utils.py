...
from src.collectors.htdf.my_bech32 import bech32_decode, convertbits, MakeHRC20TransferHexData
from src.config.constant import WithdrawStatus,  HTDF_CHAINID, HTDF_RPC_HOST, HTDF_GAS_PRICE, \
    HTDF_GAS_LIMIT, TransferFuncResponse
...
def htdf_transfer(priv_key : str, from_addr : str, to_addr : str, amount_in_htdf : float, memo : str) -> TransferFuncResponse :
    '''
    转账
    :param from_addr:  源地址
    :param to_addr:  目的地址
