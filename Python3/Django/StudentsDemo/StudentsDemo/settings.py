"""
Django settings for StudentsDemo project.
...
SECRET_KEY = 'fe)eg*%p!(kk&4%$*$7%97q+r@-%au8rf5jp)g&azk-k50g0e('
...
TEMPLATES = [
    {
        ...
        'DIRS': [  os.path.join(BASE_DIR, 'templates') ],  #这里添加templates目录
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'StudentsDemo.wsgi.application'
